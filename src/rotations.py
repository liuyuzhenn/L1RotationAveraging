...
def matrix_to_euler_angles(matrix: torch.Tensor, convention: str):
    """
...
def quaternion_raw_multiply(a: torch.Tensor, b: torch.Tensor):
    """
...
def quaternion_invert(quaternion: torch.Tensor):
    """
...
def quaternion_apply(quaternion: torch.Tensor, point: torch.Tensor):
    """
